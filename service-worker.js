const CACHE_NAME = "creative-note-v4-8-4-cache";
...
const CORE_ASSETS = [
  ...
  "./js/account.js?v=484",
  "./js/pwa.js?v=484",
  "./icons/logo-mark.svg?v=484",
  "./icons/brand-wordmark.svg?v=484",
  "./icons/settings-gear.png?v=484",
  "./icons/icon-192.png?v=484",
  "./icons/icon-512.png?v=484",
  "./icons/icon-maskable-192.png?v=484",
  "./icons/icon-maskable-512.png?v=484",
  "./icons/icon-monochrome-512.png?v=484",
  "./icons/apple-touch-icon.png?v=484",
  "./legal/legal.css?v=484",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
