const CACHE_NAME = "creative-note-v5-23-cache";
...
const CORE_ASSETS = [
  ...
  "./js/account.js?v=525",
  "./js/pwa.js?v=525",
  "./icons/logo-mark.svg?v=525",
  "./icons/brand-wordmark.svg?v=525",
  "./icons/settings-gear.png?v=525",
  "./icons/icon-192.png?v=525",
  "./icons/icon-512.png?v=525",
  "./icons/icon-maskable-192.png?v=525",
  "./icons/icon-maskable-512.png?v=525",
  "./icons/icon-monochrome-512.png?v=525",
  "./icons/apple-touch-icon.png?v=525",
  "./legal/legal.css?v=525",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
