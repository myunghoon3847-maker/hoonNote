const CACHE_NAME = "creative-note-v5-0-cache";
...
const CORE_ASSETS = [
  ...
  "./js/account.js?v=502",
  "./js/pwa.js?v=502",
  "./icons/logo-mark.svg?v=502",
  "./icons/brand-wordmark.svg?v=502",
  "./icons/settings-gear.png?v=502",
  "./icons/icon-192.png?v=502",
  "./icons/icon-512.png?v=502",
  "./icons/icon-maskable-192.png?v=502",
  "./icons/icon-maskable-512.png?v=502",
  "./icons/icon-monochrome-512.png?v=502",
  "./icons/apple-touch-icon.png?v=502",
  "./legal/legal.css?v=502",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
