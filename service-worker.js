const CACHE_NAME = "creative-note-v5-25-cache";
...
const CORE_ASSETS = [
  ...
  "./js/account.js?v=527",
  "./js/pwa.js?v=527",
  "./icons/logo-mark.svg?v=527",
  "./icons/brand-wordmark.svg?v=527",
  "./icons/settings-gear.png?v=527",
  "./icons/icon-192.png?v=527",
  "./icons/icon-512.png?v=527",
  "./icons/icon-maskable-192.png?v=527",
  "./icons/icon-maskable-512.png?v=527",
  "./icons/icon-monochrome-512.png?v=527",
  "./icons/apple-touch-icon.png?v=527",
  "./legal/legal.css?v=527",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
