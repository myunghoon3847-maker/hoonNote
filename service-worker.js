const CACHE_NAME = "creative-note-v4-9-10-cache";
...
const CORE_ASSETS = [
  ...
  "./js/account.js?v=500",
  "./js/pwa.js?v=500",
  "./icons/logo-mark.svg?v=500",
  "./icons/brand-wordmark.svg?v=500",
  "./icons/settings-gear.png?v=500",
  "./icons/icon-192.png?v=500",
  "./icons/icon-512.png?v=500",
  "./icons/icon-maskable-192.png?v=500",
  "./icons/icon-maskable-512.png?v=500",
  "./icons/icon-monochrome-512.png?v=500",
  "./icons/apple-touch-icon.png?v=500",
  "./legal/legal.css?v=500",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
