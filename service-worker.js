const CACHE_NAME = "creative-note-v4-9-4-cache";
...
const CORE_ASSETS = [
  ...
  "./js/account.js?v=494",
  "./js/pwa.js?v=494",
  "./icons/logo-mark.svg?v=494",
  "./icons/brand-wordmark.svg?v=494",
  "./icons/settings-gear.png?v=494",
  "./icons/icon-192.png?v=494",
  "./icons/icon-512.png?v=494",
  "./icons/icon-maskable-192.png?v=494",
  "./icons/icon-maskable-512.png?v=494",
  "./icons/icon-monochrome-512.png?v=494",
  "./icons/apple-touch-icon.png?v=494",
  "./legal/legal.css?v=494",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
