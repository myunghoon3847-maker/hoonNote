const CACHE_NAME = "creative-note-v5-22-cache";
...
const CORE_ASSETS = [
  ...
  "./js/account.js?v=524",
  "./js/pwa.js?v=524",
  "./icons/logo-mark.svg?v=524",
  "./icons/brand-wordmark.svg?v=524",
  "./icons/settings-gear.png?v=524",
  "./icons/icon-192.png?v=524",
  "./icons/icon-512.png?v=524",
  "./icons/icon-maskable-192.png?v=524",
  "./icons/icon-maskable-512.png?v=524",
  "./icons/icon-monochrome-512.png?v=524",
  "./icons/apple-touch-icon.png?v=524",
  "./legal/legal.css?v=524",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
