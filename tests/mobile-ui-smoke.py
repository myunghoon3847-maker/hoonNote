...
async def run():
  out = ROOT.parent / 'hoonnote_v4_5_16_testshots'; out.mkdir(exist_ok=True)
  async with async_playwright() as pw:
    ...
    try:
      for width in [320,360,375,390,412,430]:
        ...
        assert await page.locator('#openSettingsButton img').get_attribute('src') == './icons/settings-gear.png?v=467'
